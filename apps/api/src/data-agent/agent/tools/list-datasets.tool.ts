...
export function createListDatasetsTool(
  ...
  return new DynamicStructuredTool({
    name: 'list_datasets',
    description:
      'List ALL available datasets/tables in the ontology. Returns names, descriptions, and source table references. Use this when you need to discover tables beyond those provided in the system prompt, or when the initial datasets don\'t contain the data you need.',
    schema,
    func: async () => {
      try {

...
const PERMISSIONS = [
  ...
  { name: 'spreadsheet_agent:read', description: 'View spreadsheet agent runs and tables' },
  { name: 'spreadsheet_agent:write', description: 'Create and execute spreadsheet agent runs' },
  { name: 'spreadsheet_agent:delete', description: 'Delete spreadsheet agent runs' },
] as const;

...
function Show-Help {
    ...
    Write-Host "  Application:    http://localhost:8319"
    Write-Host "  API:            http://localhost:8319/api"
    Write-Host "  Swagger UI:     http://localhost:8319/api/docs"
    Write-Host "  API Health:     http://localhost:8319/api/health/live"
...
function Start-Services {
    ...
    Write-Host ""
    Write-Info "Application:  http://localhost:8319"
    Write-Info "Swagger UI:   http://localhost:8319/api/docs"
    if ($Otel) {
